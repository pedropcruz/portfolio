...
const navigationMenuTriggerStyle = cva(
	'group inline-flex h-10 w-max items-center rounded-md justify-center px-4 py-2 text-sm font-medium transition-colors hover:bg-secondary hover:text-slate-950 focus:bg-secondary focus:text-slate-950 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-slate-100/50 data-[state=open]:bg-slate-100/50'
);
